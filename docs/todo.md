...
| T3 | P1 | 🟡 待推进 | 小日向日报、商人与掉落查询 | [日报、商人与掉落查询](work/backlog/daily-report-and-drops-assistant.md) / [首页遗失区域简报](work/backlog/home-lost-sector-briefing-redesign.md) / [首页每周活动简报](work/backlog/home-weekly-activity-briefing-redesign.md) | 首页本日更新已按新边界收口为“完整遗失区域 + 重点商人预留位”，账号提醒和今日商人变化不再进入本日主卡；首页本周更新已收口为“日落任务、轮换突袭、轮换地牢、本周加成、特殊活动”五个主关注位，公共里程碑会先按 `weeklyActivityKind` 或已知突袭 / 地牢名称进入主卡，奇异商人下沉到辅助区但保留紧凑库存和装备图标，公共线索只保留未归类线索，不展示试炼、铁旗或周末窗口；遗失区域简报已接 Manifest 目的地、勇士、护盾、威胁、专家单人奖励和大师单人奖励，不展示推荐光等、通关奖励、Manifest 来源或旧 dropSummary；每周活动简报已记录从 `CharacterActivities(204)` 提取 `Grandmaster Vanguard Alerts` 和 `Weekly Dungeon Challenge` 的方案，当前可确认本周日落为“移民号的坠毁 / 崇拜”，本周高亮地牢为“晚星之主 / 二象性”；商人页已接共享 UI、Desktop 入口、公共商人刷新、9 商人目录兜底、Bungie 图标路径修复、登录角色商人库存和 `model + actions` 边界收口；下一步继续补活动、掉落来源状态、每周日落 / 地牢首页接线、更完整的购买判断，以及商人重点库存首页摘要规则 |
