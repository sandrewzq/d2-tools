...
| T3 | P1 | 🟡 进行中 | 商人结构、覆盖与官方获取来源 | [商人结构、覆盖与官方获取来源](work/backlog/vendors-and-drop-sources.md) | 已修复切换菜单后永久加载，按官方商人组收口地点与子库存，并清理未解析的 Manifest 动态变量；继续验收 Offer 时效、去重和机灵模组 A/B |
