...
|---|---|---|---|---|---|
| T14 | P1 | 🟡 待验收 | 配装页逐部位护甲调整与属性模组求解 | [任务说明](work/backlog/T14-armor-planner-slot-aware-mods.md) | 使用真实账号核对五部位 `+5/+10 属性模组` 精确分配、耗能功能 Plug 的唯一 Socket 分配、零能量清空 Plug、T5 护甲调整、异域可选范围、逐件能量账本、候选保存和执行前零写入复核；本轮未运行本地自动化验证 |
