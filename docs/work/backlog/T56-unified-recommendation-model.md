...
| `user-guide.md` §8.3 | 「导入 DIM Wishlist」等切换前名称（已在 `docs/todo.md` 登记） | ✅ `:27` / `:147` / `:167` 三处改为「愿望单文本」（`§8.3` 正文本身在 T68 收尾时已改完）；`security.md:20`、`T45-weekly-farming-checklist.md:142`（该文件已于 2026-09-20 并入 `T91-todo-list.md`）两处同名字样一并改掉 |
