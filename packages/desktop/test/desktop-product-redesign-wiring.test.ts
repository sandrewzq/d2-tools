...
describe("desktop product redesign wiring", () => {
  it("lands the approved prototype structure into the real desktop pages", () => {
    ...
    expect(homeDashboard).toContain("home-weekly-panel");
    expect(homeDashboard).toContain("本日更新");
    expect(homeDashboard).toContain("本周更新");
    ...
    expect(styles).toContain(".home-reward-item > div");
    expect(styles).toContain('.home-reward-item[data-source="gambit"]');
    expect(styles).toContain('.home-reward-item[data-source="raid"]');
