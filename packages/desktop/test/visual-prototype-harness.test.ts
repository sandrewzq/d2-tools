...
describe("visual prototype harness", () => {
  it("provides a repeatable home prototype comparison script", () => {
    ...
    expect(script).toContain("reference-dark-1920x1080.png");
    expect(script).toContain("app-dark-1920x1080.png");
    expect(script).toContain("compare-dark-1920x1080.png");
    expect(script).toContain("report.json");
    expect(script).toContain("home-operations-desk");
    expect(script).toContain("home-operations-week");
    expect(script).toContain("home-operations-source");
  ...
  it("lets Electron capture the real app with computed styles for visual review", () => {
    ...
    expect(mainProcess).toContain('home: ".home-operations-desk"');
    ...
    expect(mainProcess).toContain("home-operations-desk");
    expect(mainProcess).toContain("home-operations-week");
    expect(mainProcess).toContain("home-operations-stock");
    expect(mainProcess).toContain("home-operations-live");
  ...
  it("keeps home prototype classes isolated from global status overrides", () => {
    ...
    expect(homePageView).toContain("home-operations-live-block");
