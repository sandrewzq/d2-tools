...
export const homeCopy: Record<InterfaceLocale, LocaleCopy["home"]> = {
    ...
    "en-US": {
      inline: {
        ...
        "日落挑战待确认": "Nightfall challenge pending",
        ...
        "轮换已确认，掉落关系尚未核对。": "The rotation is confirmed; its loot relation has not been cross-checked.",
        "这次没读到掉落池定义，刷新首页可以重试。": "The loot pool definition could not be read this time. Refresh the home page to retry.",
        "项已确认": "confirmed",
